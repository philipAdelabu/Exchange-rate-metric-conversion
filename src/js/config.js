...
/* 
  ...
  https://api.unitconvr.com/v1/categories
  https://api.unitconvr.com/v1/units/{category}

  call
  https://api.unitconvr.com/v1/convert?from=meter&to=foot&value=100&category=length
